/* linux/arch/arm/drivers/rtc/rtc-smdkc110.c
 *
...
static int __devinit smdkc110_rtc_probe(struct platform_device *pdev)
{
	...
	/*check whether rtc has previous value set*/
...
static int smdkc110_rtc_suspend(struct platform_device *pdev, pm_message_t state)
{
	...
	//jeff, remove TICNT save/restore. Otherwise, TICK timer will error in resume	
